 ...
 *     and 3 low pulses, total length (1+3)*pulselength, i.e:s
 *      _
 *     | |___
...
#endif
  { 350, {  1, 17 }, {  1,  3 }, {  3,  1 }, false },    // protocol 1
 ...
 */
void RCSwitch::send(unsigned long code, unsigned int length , bool stretch ) {
  ...
  for (int nRepeat = 0; nRepeat < nRepeatTransmit; nRepeat++) {
    ...
    if(stretch){  // joe added streach to add 3pulses high at end if true
     digitalWrite(this->nTransmitterPin, 1);
     delayMicroseconds( this->protocol.pulseLength * 3);  
    }
